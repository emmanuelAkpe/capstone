  ...
  return (
    <div className="flex flex-col py-5 lg:flex-row mx-5 mt-5 items-center justify-center bg-dzoma-blue-black   rounded-3xl lg:p-5  ">
      ...
      <div className="flex-1 px-10 lg:ml-20">
        ...
        <button
          className="bg-dzoma-yellow hidden lg:block md:block text-dzoma-red font-bold rounded-lg px-6 py-2 my-3"
      ...
      <div className="  lg:mr-32 flex flex-col gap-10 justify-center items-center">
        ...
        <button
          className="lg:hidden md:hidden sm:hidden bg-dzoma-yellow text-dzoma-red font-bold rounded-lg px-6 py-2 my-3 "
          onClick={() => setshow(true)}
        >
          Start Now
        </button>
