          ...
          <div className='flex items-center justify-center flex-wrap'>
            <div className='w-full sm:w-1/2 text-left py-8 sm:py-12 md:py-16 lg:py-20 xl:pb-28 px-4 md:px-6 lg:px-8'>
              <h1
                ...
                data-aos-delay='500'
              >
                <span className='block xl:inline text-dzoma-yellow'>Fast and Secured</span>{' '}
              ...
              <p className='py-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0'>
                Enjoy an experience of safe travel with the Oya! App - flexible
                routes, lower fares and greater experience. Travelling between
                cities should be simple and adaptable with increased mobility
                and accessibility as the transportation infrastructure expands,
                and Oya Ghana makes this possible in real-time. Passengers
                recieve cutting-edge, innovative, and sustainable modes of
                transportation.
              </p>
